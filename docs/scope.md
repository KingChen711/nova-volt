...
> Plan hiện hành: [M3 — Telemetry, TimescaleDB & Production Calendar](plans/M3-telemetry-timescaledb-production-calendar.md) — DoD, thiết kế đang chạy, cách đo và nợ có hạn. Diễn biến và số đo theo ngày nằm trong benchmarks/ADR.
